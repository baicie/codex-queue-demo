...
const requiredTranslationKeys = [
  ...
  "runOutput.title",
  "runOutput.description",
  "runOutput.run",
  "runOutput.refresh",
  "runOutput.loadingRuns",
  "runOutput.loadingOutput",
  "runOutput.attempt",
  "runOutput.loadError",
  "runOutput.emptyTitle",
  "runOutput.emptyDescription",
  "runOutput.truncated",
  "runOutput.tabs.finalOutput",
  "runOutput.tabs.events",
  "runOutput.tabs.stderr",
  "runOutput.empty.finalOutput",
  "runOutput.empty.events",
  "runOutput.empty.stderr",
  "retryPolicy.title",
